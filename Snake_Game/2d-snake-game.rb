...
COLOR_LIST = ['teal', 'green', 'blue', 'orange', 'red', 'purple', 'brown']
SNAKE_COLOR = [COLOR_LIST.sample, COLOR_LIST.sample, COLOR_LIST.sample, COLOR_LIST.sample]
...
class Snake
  ...
  def draw
    @positions.each do |position|
      Square.new(x: position[0] * SQUARE_SIZE, y: position[1] * SQUARE_SIZE, size: SQUARE_SIZE - 1, color: SNAKE_COLOR)
    end
  end
